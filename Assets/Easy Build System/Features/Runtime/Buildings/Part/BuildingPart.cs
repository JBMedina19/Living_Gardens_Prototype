...
namespace EasyBuildSystem.Features.Runtime.Buildings.Part
{
    ...
    public class BuildingPart : MonoBehaviour
    {
        ...
        public enum StateType { NONE, PREVIEW, DESTROY, EDIT, PLACED }
        ...
        {
#if UNITY_EDITOR
            AssetDatabase.SetLabels(gameObject, new string[1] { "BuildingPart" });
        ...
        public void ChangeState(StateType state)
        {
            ...
            for (int i = 0; i < m_PreviewSettings.DisableGameObjects.Length; i++)
            {
                ...
                {
                    m_PreviewSettings.DisableGameObjects[i].SetActive(state != StateType.PREVIEW);
                }
            }
            ...
            for (int i = 0; i < m_PreviewSettings.DisableMonoBehaviours.Length; i++)
            {
                ...
                {
                    m_PreviewSettings.DisableMonoBehaviours[i].enabled = state != StateType.PREVIEW;
                }
            }
