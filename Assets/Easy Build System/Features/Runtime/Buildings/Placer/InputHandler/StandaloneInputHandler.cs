...
namespace EasyBuildSystem.Features.Runtime.Buildings.Placer.InputHandler
{
    public class StandaloneInputHandler : BaseInputHandler
    {
        ...
        public InputSettings GetInputSettings { get { return m_InputSettings; } }
        ...
        void Start()
        {
            Debug.LogWarning("<b>Easy Build System</b> : The New Input System support is not installed!\n" +
                "You can import it directly via the Package Importer.");
        }
#endif
    }
}